...
![业务 2：Attestation 主线](img/business2.png)
...
![B2 Attestation Generation](img/business2_generation.png)

### B2 Attestation Broadcast（广播） {#b2-attestation-broadcast}

![B2 Attestation Broadcast](img/business2_broadcast.png)

### B2 Attestation Receive（接收） {#b2-attestation-receive}

![B2 Attestation Receive](img/business2_receive.png)

### B2 Attestation Processing（验证与处理） {#b2-attestation-processing}

![B2 Attestation Processing](img/business2_processing.png)
