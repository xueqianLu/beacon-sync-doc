...
## 5.1 multistream-select协议

### 5.1.1 为什么需要协议协商

在P2P网络中，peer需要就使用的协议达成一致：
...
✅ **RPC协议**: 完整的Req/Resp协议集
✅ **Gossipsub主题**: 结构化的主题命名
✅ **SSZ+Snappy编码**: 高效的序列化和压缩
✅ **版本管理**: 平滑的协议升级路径
✅ **错误处理**: 优雅的协商失败处理

协议协商是P2P通信的基础，确保节点间能正确交互。

---

**下一章预告**: 第6章将深入讲解discv5节点发现机制。
